<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="description">
        {{ __('Actualiza tu foto de perfil, si necesitas cambiar algún otro dato en caso de ser incorrecto, contacta con el administrador del sistema en el email: ') }} {{$_ENV['ADMIN_MAIL']}}
    </x-slot>
