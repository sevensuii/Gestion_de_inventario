<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('objetos') }}" :active="request()->routeIs('objetos')">
                {{ __('Objetos') }}
            </x-jet-responsive-nav-link>
        </div>
        <div class="pt-2 pb-3 space-y-1">
        ...
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('platform.main') }}" :active="request()->routeIs('platform.main')">
                {{ __('AdminPanel') }}
            </x-jet-responsive-nav-link>
        </div>
