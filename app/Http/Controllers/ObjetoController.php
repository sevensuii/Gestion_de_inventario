...
class ObjetoController extends Controller
{
    ...
    {
        $objetos = DB::select("SELECT o.id, o.id_aula , d.id_departamento, o.nombre, concat('P', a.piso, 'A', a.numero) as aula, count(*) as replicas ,d.nombre as departamento, o.descripcion
